    ...
    <div>
      ...
      <div style={{ textAlign: "center", padding: "56px 0 40px" }}>
        ...
        <p className="hero-p" style={{ fontSize: 17, color: C.text2, margin: "0 auto 48px", maxWidth: 520, lineHeight: 1.7 }}>
          Terjemahkan bahasa Sunda ke Indonesia atau Indonesia ke Sunda dengan tingkatan Halus (Lemes), Sedang, dan Kasar (Wantah).
        </p>
        <div ref={tRef}>
      ...
      <div style={{ padding: "64px 0 48px", textAlign: "center" }}>
        ...
        <h2 className="section-h2" style={{ fontSize: 32, fontWeight: 700, color: C.text, margin: "0 0 12px" }}>Translate Bahasa Sunda ke Indonesia dan Sebaliknya</h2>
        <p style={{ color: C.text2, fontSize: 16, margin: "0 0 40px" }}>Terjemahkan kata, kalimat, hingga teks dengan mudah dan cepat.</p>
        <div className="steps-grid">
          {[
            { n:"1", t:"Pilih Bahasa", d:"Pilih bahasa terjemahan, dari Indonesia ke Sunda atau Sunda ke Indonesia." },
      ...
      <div style={{ padding: "16px 0 64px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: C.text2, fontSize: 16 }}>Pilihan translate bahasa Sunda berdasarkan undak usuk basa Sunda.</p>
        </div>
        {FEATURES.map((f, i) => (
      ...
      <div style={{ background: C.greenBg, borderRadius: 20, padding: "48px 40px", textAlign: "center", border: `1px solid ${C.greenBorder}`, marginBottom: 72 }}>
        ...
        <h2 style={{ fontSize: 24, fontWeight: 700, color: C.text, margin: "0 0 12px" }}>Pelajari Lebih Dalam tentang Bahasa Sunda</h2>
        <p style={{ color: C.text2, fontSize: 15, margin: "0 0 24px", maxWidth: 400, marginLeft: "auto", marginRight: "auto" }}>
          Artikel seputar budaya, sejarah, undak usuk basa, dan panduan belajar bahasa Sunda untuk semua kalangan.
        </p>
        <Link href="/blog"
